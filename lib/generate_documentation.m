%% Generate MATLAB documentation for ALFONSO
...
addpath(fileparts(mF));

oF = mF+filesep+"doc";

opts = struct(  'toolboxName',      "ALFONSO", ...
                'delOld',           true, ...
                'mFolder',          [mF], ...
                'outputFolder',     [oF], ...
                'excludeFolder',	  ["doc","examples","lib","tests"], ...
                'excludeFile',      [""], ...
                'htmlMetaFolder',   "ressources", ...
                'htmlTemplate',     "m2doc-standard", ...
                'startPage',        ["Welcome_to_ALFONSO.html"], ...
                'toc',              [], ...
                'verbose',          false);
            
%opts.toc        = {"Welcome_to_ALFONSO",  "/",    {} ; ...
%                    "Additional",       "help", {}};
